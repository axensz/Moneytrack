...
- Actualizar las dependencias directas y transitivas necesarias para eliminar las 17 alertas actuales y cualquier vulnerabilidad adicional reportada por `npm audit`, sin incorporar paquetes de runtime; la única dependencia nueva permitida es el paquete oficial de desarrollo para probar reglas en el emulador.
