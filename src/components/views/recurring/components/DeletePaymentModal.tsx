  ...
  return (
    <div className="fixed inset-0 z-[110] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div
        ...
        aria-describedby="dpm-desc"
        className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 max-w-sm w-full"
      >
        <h3 id="dpm-title" className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">
          ¿Eliminar pago periódico?
        </h3>
        <p id="dpm-desc" className="text-gray-600 dark:text-gray-400 mb-6 text-sm">
