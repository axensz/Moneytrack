        ...
        <div className="flex gap-2 border-b border-gray-200 dark:border-purple-800" role="tablist">
          {tabs.map(tab => (
            <button
              ...
              className={`flex items-center gap-2 px-4 py-3 text-base font-medium transition-all whitespace-nowrap focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-purple-500 ${view === tab.key
