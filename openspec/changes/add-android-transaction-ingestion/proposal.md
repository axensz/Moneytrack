...
- **Android:** nuevo proyecto `android-capture/`, `applicationId` `com.moneytrack.capture`, `minSdk 26`, `compileSdk/targetSdk 36`, autenticación Google mediante Credential Manager y Firebase Auth, y Cloud Firestore.
