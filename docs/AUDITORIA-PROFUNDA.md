...
> **Verificación:** 6/6 con revisión adversarial. Barrera: `tsc --noEmit` limpio + suite `463 tests` verde. Cambios en working tree (sin commitear todavía).
> **Pendiente inmediato siguiente:** A2 (mock de Firestore + tests de la capa de escritura de dinero), A1 (deudas con código real), A3 (tests de los 6 servicios de umbral), A5 (a11y de modales destructivos).
