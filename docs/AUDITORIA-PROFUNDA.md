...
> **Verificación:** 18 hallazgos resueltos + 1 refutado, con revisión adversarial. `tsc --noEmit` limpio · eslint sin warnings · suite global **516 tests** verde · `next build` OK.
