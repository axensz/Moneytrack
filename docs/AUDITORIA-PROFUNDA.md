...
> **Verificación:** 15 hallazgos resueltos + 1 refutado, con revisión adversarial. `tsc --noEmit` limpio + suite global **522 tests** verde.
...
> **Pendiente:** deuda estructural (`FinanceContext` monolítico, dos sistemas de botones + tokens semánticos/A4, god-files `HelpModal`/`ImportTransactionsModal`); medios sueltos de UI/a11y, producto y rendimiento del informe.
